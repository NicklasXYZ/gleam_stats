...
pub fn seed_mt19937_test() {
  ...
  [#(1000, 3298208229), #(2000, 4018181980), #(3000, 824242727)]
  ...
  [#(1000, 46010871), #(2000, 1714137953), #(3000, 2335134544)]
  ...
  [#(1000, 1964173339), #(2000, 3506793793), #(3000, 2009758904)]
  |> check_mt1993_randints(500)
}

fn check_mt1993_randints(tuples: List(#(Int, Int)), seed: Int) {
  tuples
