...
-spec map_errors(
    {ok, CGK} | {error, list(decode_error())},
...
-spec result(
    fun((dynamic()) -> {ok, CHP} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CHR} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {ok, CHP} | {error, CHR}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic()) -> {ok, CHW} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
                                                                                                 list(CHW)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
...
-spec optional(fun((dynamic()) -> {ok, CIB} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
                                                                                                     gleam@option:option(CIB)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec field(
    any(),
    fun((dynamic()) -> {ok, CIL} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CIL} | {error, list(decode_error())}).
...
-spec element(
    integer(),
    fun((dynamic()) -> {ok, CIR} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CIR} | {error, list(decode_error())}).
...
-spec tuple2(
    fun((dynamic()) -> {ok, CJM} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CJO} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CJM, CJO}} | {error, list(decode_error())}).
...
-spec tuple3(
    ...
    fun((dynamic()) -> {ok, CJT} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CJV} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CJR, CJT, CJV}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic()) -> {ok, CJY} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKC} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKE} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CJY, CKA, CKC, CKE}} |
    {error, list(decode_error())}).
...
-spec tuple5(
    fun((dynamic()) -> {ok, CKH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKJ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKL} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKN} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKP} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CKH, CKJ, CKL, CKN, CKP}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    ...
    fun((dynamic()) -> {ok, CKW} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CKY} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CLA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CLC} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CKS, CKU, CKW, CKY, CLA, CLC}} |
    {error, list(decode_error())}).
...
-spec map(
    fun((dynamic()) -> {ok, CLF} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CLH} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, gleam@map:map_(CLF, CLH)} |
    {error, list(decode_error())}).
...
-spec any(list(fun((dynamic()) -> {ok, CLQ} | {error, list(decode_error())}))) -> fun((dynamic()) -> {ok,
                                                                                                      CLQ} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec decode2(
    fun((CLU, CLV) -> CLW),
    fun((dynamic()) -> {ok, CLU} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CLV} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CLW} | {error, list(decode_error())}).
...
-spec decode3(
    ...
    fun((dynamic()) -> {ok, CMB} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMC} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CMD} | {error, list(decode_error())}).
...
-spec decode5(
    fun((CMS, CMT, CMU, CMV, CMW) -> CMX),
    fun((dynamic()) -> {ok, CMS} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMT} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMU} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMV} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMW} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CMX} | {error, list(decode_error())}).
...
-spec decode6(
    fun((CNE, CNF, CNG, CNH, CNI, CNJ) -> CNK),
    fun((dynamic()) -> {ok, CNE} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CNF} | {error, list(decode_error())}),
...
) -> fun((dynamic()) -> {ok, CNK} | {error, list(decode_error())}).
...
-spec decode8(
    fun((COI, COJ, COK, COL, COM, CON, COO, COP) -> COQ),
...
-spec decode9(
    fun((CPA, CPB, CPC, CPD, CPE, CPF, CPG, CPH, CPI) -> CPJ),
    ...
    fun((dynamic()) -> {ok, CPI} | {error, list(decode_error())})
